...
if __name__ == '__main__':
    ...
    iconbit = os.path.join(WORK_PATH, "asteroid.ico")
    tk.iconbitmap(iconbit)
    ...
    bg = os.path.join(WORK_PATH, 'bg.png')
    img_obj1 = PhotoImage(file=bg)
    sc.create_image(0, 0, anchor=NW, image=img_obj1)

    bg2 = os.path.join(WORK_PATH, 'bg2.png')
    img_obj2 = PhotoImage(file=bg2)
    ...
    anim_count, anim_speed, anim_limit = 0, 60, 6000

    score, lines = 0, 0
    scores = {0: 0, 1: 100, 2: 300, 3: 700, 4: 1500}
    record = get_record()

    sc.create_text(505, 30, text="TETRIS", font=("ALGERIAN", 50), fill="red", anchor=NW)
    sc.create_text(535, 780, text="score:", font=("ALGERIAN 2", 35), fill="white", anchor=NW)
    _score = sc.create_text(550, 840, text=str(score), font=("ALGERIAN", 35), fill="white", anchor=NW)
    sc.create_text(525, 650, text="record:", font=("ALGERIAN", 35), fill="white", anchor=NW)
    _record = sc.create_text(550, 710, text=record, font=("ALGERIAN", 35), fill="gold", anchor=NW)
    ...
    while app_running:
        if app_running:
            ...
            for i in range(4):
                ...
                fig.append(game_sc.create_rectangle(
                    figure_rect_x,
                    figure_rect_y,
                    figure_rect_x + TILE,
                    figure_rect_y + TILE,
            ...
            for i in range(4):
                ...
                fig2.append(sc.create_rectangle(
                    figure_rect_x,
                    figure_rect_y,
                    figure_rect_x + TILE,
                    figure_rect_y + TILE,
